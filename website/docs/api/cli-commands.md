...
Your application must initialize the ESP Console REPL. See the [with_cli example](https://github.com/WiFiConfig/esp_wifi_config/tree/main/examples/with_cli) for a complete setup.
